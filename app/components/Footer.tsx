        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex gap-3.5">
              ...
              <a href="#" aria-label="Connect with Axpert Cera on LinkedIn" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:border-gold hover:text-gold transition-colors">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 text-white/65 text-[13px]">
                ...
                <a href="mailto:info@axpertcera.com" className="hover:text-white transition-colors">
                  info@axpertcera.com
                </a>
              </div>
