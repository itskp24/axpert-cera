...
import { Search, Heart, User, ShoppingBag, X, Mail, MapPin, Menu } from 'lucide-react';
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 flex items-center justify-between">
          ...
          <div className="flex flex-1 justify-end items-center gap-3 md:gap-6">
            <button
              ...
              className="flex items-center justify-center text-navy p-2 hover:bg-light-gray rounded-full transition-all duration-300"
            >
            ...
            <a href="https://wa.me/919429339212?text=Hello,%20I%20would%20like%20to%20inquire%20about%20Axpert%20Cera%20products." target="_blank" rel="noopener noreferrer" className="hidden sm:flex items-center justify-center text-navy p-2 hover:bg-light-gray hover:text-[#25D366] rounded-full transition-all group" aria-label="WhatsApp">
            ...
            <button
              ...
              className="lg:hidden flex items-center justify-center text-navy p-2 hover:bg-light-gray rounded-full transition-all duration-300"
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="lg:hidden bg-white border-t border-[#F0F0EE] overflow-hidden"
            >
              <div className="max-w-[1280px] mx-auto px-5 py-8">
                  ...
                  {[
                    ...
                    <li key={item.label}>
                      <Link
                        ...
                        className={`text-[18px] font-semibold tracking-[0.1em] text-navy block py-2 ${pathname === item.href ? 'text-[#C4A484]' : ''}`}
                      >
                        {item.label}
                      </Link>
                    </li>
                ...
                <div className="mt-10 pt-8 border-t border-[#F0F0EE] flex flex-wrap gap-4">
                  <a href="mailto:info@axpertcera.com" className="flex items-center gap-3 text-navy hover:text-[#C4A484] transition-colors">
                    <Mail size={18} />
                    <span className="text-[12px] font-bold uppercase tracking-widest">Email Us</span>
                  </a>
                  <a href="https://wa.me/919429339212" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-navy hover:text-[#25D366] transition-colors">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.582 2.128 2.182-.573c.978.58 1.911.928 3.145.929 3.178 0 5.767-2.587 5.768-5.766 0-3.18-2.587-5.771-5.764-5.771zm3.392 8.244c-.144.405-.837.774-1.17.824-.299.045-.677.063-1.092-.069-.252-.08-.575-.187-.988-.365-1.739-.747-2.874-2.511-2.96-2.626-.087-.115-.708-.941-.708-1.797 0-.856.448-1.274.607-1.446.16-.171.347-.214.464-.214.118 0 .234.002.336.006.107.005.252-.04.395.302.144.347.491 1.196.533 1.284.045.087.073.189.014.305-.057.115-.088.19-.174.289-.087.101-.183.226-.26.303-.093.093-.191.194-.081.385.111.191.491.808 1.056 1.312.729.648 1.343.85 1.534.942.191.092.303.077.417-.053.114-.13.491-.569.622-.764.131-.194.262-.163.443-.097.182.067 1.155.545 1.352.643.197.099.328.146.375.228.046.082.046.475-.101.88z" />
                    </svg>
                    <span className="text-[12px] font-bold uppercase tracking-widest">WhatsApp</span>
                  </a>
                </div>
              </div>
            </motion.div>
