            ...
            <div className="grid grid-cols-4 gap-2 mt-4">
              {SPOTLIGHT_IMAGES.map((img, idx) => (
                <div
                  ...
                  className={`aspect-square bg-[#FAF9F6] rounded-[2px] p-2 border-2 cursor-pointer relative overflow-hidden group transition-all duration-300 ${activeImg === img ? 'border-navy-dark' : 'border-transparent'
                    }`}
                >
