...
export default function Heritage() {
  return (
    <section id="about" className="py-24 bg-navy-dark text-white relative overflow-hidden" aria-labelledby="about-heading">
      ...
      <div className="max-w-[1440px] mx-auto px-5 md:px-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
              ...
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                <div className="relative aspect-[4/3] w-full overflow-hidden shadow-2xl rounded-[4px] group">
                  <Image
                    ...
                    alt="Precision Crafting of Ceramic Sanitaryware at Axpert Cera Factory, Morbi Gujarat"
                    fill
                    className="object-cover transition-transform duration-1000 group-hover:scale-[1.05]"
                ...
                <div className="relative aspect-[4/3] w-full overflow-hidden shadow-2xl rounded-[4px] group">
                  <Image
                    ...
                    alt="Quality Control and Finishing of Premium Ceramic Products at Axpert Cera, Morbi Gujarat"
                    fill
                    className="object-cover transition-transform duration-1000 group-hover:scale-[1.05]"
                    sizes="(max-width: 1024px) 50vw, 30vw"
                  />
          ...
          <div className="lg:col-span-6 xl:col-span-5 flex flex-col justify-center">
            ...
            <h2 id="about-heading" className="font-serif text-[clamp(40px,5vw,64px)] font-normal mb-8 leading-[1.05] text-white">
              About Axpert <br className="hidden md:block" />
              <span className="text-white/40 italic">Cera.</span>
            </h2>

            <div className="flex flex-col gap-6 text-[15px] leading-[1.8] text-white/70 font-light mb-12">
              <p>
                Axpert Cera is a Gujarat-based leading sanitaryware manufacturer established in 2019. We offer a wide range of premium ceramic sanitaryware products including one piece toilets, wash basins, wall hung closets, designer basins, and urinals - serving customers in Morbi, Rajkot, Ahmedabad, Gandhinagar, Surat, Vadodara, Chotila, SurendraNagar, and across India.
              </p>
              <p>
                With ISO-certified quality and modern designs, we deliver products that combine durability, elegance, and international standards. Our 125+ product range is crafted for modern bathrooms with precision and expert craftsmanship.
              </p>

              <div className="mt-4 pl-6 border-l w-full border-[#C4A484]">
                <p className="font-serif italic text-[20px] text-white/90 leading-snug">
                  &ldquo;Handcrafted Luxury, International Standards.&rdquo;
                </p>
              </div>
            </div>
